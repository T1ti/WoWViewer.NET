...
| Per-instance animation selection | Not yet | Store sequence and playback time per placement instead of evaluating sequence 0 once for every instance. |
